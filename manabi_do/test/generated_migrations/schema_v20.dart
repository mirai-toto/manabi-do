...
class VocabTranslations extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  VocabTranslations(this.attachedDatabase, [this._alias]);
  ...
  @override
  VocabTranslations createAlias(String alias) {
    return VocabTranslations(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(vocab_id, locale)'];
  @override
  bool get dontWriteConstraints => true;
}
...
class DatabaseAtV20 extends GeneratedDatabase {
  ...
  late final VocabTranslations vocabTranslations = VocabTranslations(this);
