...
/// Evaluate a single [userStroke] against one [refStroke] KanjiVG [Path].
bool evaluateSingleStroke(
  List<Offset> userStroke,
  Path refStroke, {
  double threshold = 25.0,
}) {
  final ref = normalizeStroke(samplePath(refStroke), 100);
  final user = normalizeStroke(userStroke, 100);
