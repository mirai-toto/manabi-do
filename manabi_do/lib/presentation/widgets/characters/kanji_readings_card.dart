...
class KanjiReadingsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final onReadings = parseKanjiReadings(kanji.onReading);
    final kunReadings = parseKanjiReadings(kanji.kunReading);
      ...
      children: [
        ...
        Expanded(
          child: Wrap(
            ...
            runSpacing: 4,
            children: readings
                .map((r) => KanjiReadingChip(reading: r, isKun: isKun))
                .toList(),
          ),
        ),
      ],
...
class KanjiReadingChip extends StatelessWidget {
  final String reading;
  final bool isKun;
  const KanjiReadingChip({
    super.key,
    ...
    if (isKun && reading.contains('.')) {
      ...
      content = RichText(
        text: TextSpan(
          children: [
            TextSpan(
              text: reading.substring(0, dotIdx),
              style: AppTextStyles.jpBody.copyWith(color: textColor),
            ),
            TextSpan(
              text: reading.substring(dotIdx),
