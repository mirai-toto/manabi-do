  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: t.onSurface.withValues(alpha: 0.09),
            blurRadius: 12,
...
class ReaderBodyText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      text,
      style: AppTextStyles.body.copyWith(color: context.tokens.onSurface),
    );
  }
}
        ...
        children: [
          ...
          Text(
            ...
            style: AppTextStyles.bodySmall.copyWith(
              color: t.onPrimaryContainer.withValues(alpha: 0.7),
            ),
          ),
        ],
      ),
