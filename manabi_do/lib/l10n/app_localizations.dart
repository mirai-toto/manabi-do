...
abstract class AppLocalizations {
  ...
  /// No description provided for @sentenceFillIn.
  ///
  /// In en, this message translates to:
  /// **'Sentence'**
  String get sentenceFillIn;

  /// No description provided for @sentenceFillInPrompt.
  ///
  /// In en, this message translates to:
  /// **'Fill in the blank'**
  String get sentenceFillInPrompt;
  ...
  /// No description provided for @kanjiPracticed.
  ///
  /// In en, this message translates to:
  /// **'{count} kanji practiced'**
  ...
  /// No description provided for @flashcardJapaneseQuestion.
  ///
  /// In en, this message translates to:
  /// **'How do you say this in Japanese?'**
  String get flashcardJapaneseQuestion;
  ...
  ///
  /// In en, this message translates to:
  /// **'All SRS cards will be permanently deleted.'**
  ...
  /// No description provided for @aboutKanjiVgNotice.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @aboutKanjiVgLink.
  ///
  /// In en, this message translates to:
  /// **'kanjivg.tagaini.net'**
  String get aboutKanjiVgLink;

  /// No description provided for @aboutTatoebaNotice.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @aboutTatoebaLink.
  ///
  /// In en, this message translates to:
  /// **'tatoeba.org'**
  String get aboutTatoebaLink;
  ...
  /// No description provided for @quitPracticeTitle.
  ///
  /// In en, this message translates to:
  /// **'Leave session?'**
  String get quitPracticeTitle;

  /// No description provided for @quitPracticeBody.
  ///
  /// In en, this message translates to:
  /// **'Your remaining items won\'t be reviewed.'**
  ...
  /// No description provided for @reviewAndStudy.
  ///
  /// In en, this message translates to:
  /// **'Review & study'**
  String get reviewAndStudy;
  ...
  /// In en, this message translates to:
  /// **'Search kanji'**
  String get searchKanji;

  /// No description provided for @searchKanjiHint.
  ///
  /// In en, this message translates to:
  /// **'Kanji, reading, or meaning…'**
  String get searchKanjiHint;

  /// No description provided for @searchKanjiPrompt.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @practiceSettingsTitle.
  ///
  /// In en, this message translates to:
  /// **'Practice settings'**
  String get practiceSettingsTitle;

  /// No description provided for @practiceSettingsRecognition.
  ///
  /// In en, this message translates to:
  /// **'Recognition'**
  String get practiceSettingsRecognition;

  /// No description provided for @recognitionStrict.
  ///
  /// In en, this message translates to:
  /// **'Strict'**
  String get recognitionStrict;

  /// No description provided for @recognitionNormal.
  ///
  /// In en, this message translates to:
  /// **'Normal'**
  String get recognitionNormal;

  /// No description provided for @recognitionLenient.
  ///
  /// In en, this message translates to:
  /// **'Lenient'**
  String get recognitionLenient;

  /// No description provided for @practiceSettingsSessionLength.
  ///
  /// In en, this message translates to:
  /// **'Session length'**
  String get practiceSettingsSessionLength;

  /// No description provided for @practiceSettingsMcqChoices.
  ///
  /// In en, this message translates to:
  /// **'Options per question'**
  String get practiceSettingsMcqChoices;
  ...
  /// No description provided for @practiceSettingsHint.
  ///
  /// In en, this message translates to:
  /// **'Hint'**
  String get practiceSettingsHint;

  /// No description provided for @hintMeaning.
  ///
  /// In en, this message translates to:
  /// **'Meaning'**
  String get hintMeaning;

  /// No description provided for @hintReadings.
  ///
  /// In en, this message translates to:
  /// **'Readings'**
  String get hintReadings;

  /// No description provided for @hintBoth.
  ///
  /// In en, this message translates to:
  /// **'Both'**
  String get hintBoth;

  /// No description provided for @ghostKanjiLabel.
  ///
  /// In en, this message translates to:
  /// **'Ghost kanji'**
  String get ghostKanjiLabel;

  /// No description provided for @ghostKanjiSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Show kanji outline while drawing'**
  String get ghostKanjiSubtitle;

  /// No description provided for @snapToReferenceLabel.
  ///
  /// In en, this message translates to:
  /// **'Snap to reference'**
  String get snapToReferenceLabel;

  /// No description provided for @snapToReferenceSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Replace correct strokes with clean reference'**
  String get snapToReferenceSubtitle;

  /// No description provided for @showStrokeCountLabel.
  ///
  /// In en, this message translates to:
  /// **'Show stroke count'**
  String get showStrokeCountLabel;

  /// No description provided for @showStrokeCountSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Display number of strokes as a hint'**
  ...
  /// No description provided for @mcqPractice.
  ///
  /// In en, this message translates to:
  /// **'Multiple Choice'**
  String get mcqPractice;
  ...
  /// No description provided for @sentenceSettingsLabel.
  ///
  /// In en, this message translates to:
  /// **'Sentence exercise'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Furigana in question'**
  String get showSentenceFuriganaLabel;

  /// No description provided for @showSentenceFuriganaSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Show reading above kanji in the sentence'**
  String get showSentenceFuriganaSubtitle;

  /// No description provided for @showChoiceFuriganaLabel.
  ///
  /// In en, this message translates to:
  /// **'Furigana in choices'**
  String get showChoiceFuriganaLabel;

  /// No description provided for @showChoiceFuriganaSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Show reading above kanji in answer options'**
  String get showChoiceFuriganaSubtitle;

  /// No description provided for @translationModeLabel.
  ///
  /// In en, this message translates to:
  /// **'Translation'**
  String get translationModeLabel;

  /// No description provided for @translationModeAlways.
  ///
  /// In en, this message translates to:
  /// **'Always'**
  String get translationModeAlways;

  /// No description provided for @translationModeOnDemand.
  ///
  /// In en, this message translates to:
  /// **'Button'**
  String get translationModeOnDemand;

  /// No description provided for @translationModeNever.
  ///
  /// In en, this message translates to:
  /// **'Never'**
